      ...
      <div class="card-toolbar">
        ...
        >
          <span class="svg-icon svg-icon-2">
            <inline-svg src="/static/dashboard/media/icons/duotune/general/gen024.svg" />
          </span>
        </button>
        <Dropdown1></Dropdown1>
        <!--end::Menu-->
            ...
            <template v-for="(item, index) in items" :key="index">
              <tr>
                ...
                <td class="text-end">
                  ...
                  >
                    <span class="svg-icon svg-icon-2">
                      <inline-svg src="/static/dashboard/media/icons/duotune/arrows/arr064.svg" />
                    </span>
                  </a>
                </td>
              </tr>
...
export default defineComponent({
  ...
  setup() {
    const items = [
      {
        image: "/static/dashboard/media/svg/brand-logos/plurk.svg",
        info: {
          title: "Top Authors",
      ...
      {
        image: "/static/dashboard/media/svg/brand-logos/telegram.svg",
        info: {
      ...
      {
        image: "/static/dashboard/media/svg/brand-logos/vimeo.svg",
        info: {
          title: "New Users",
      ...
      {
        image: "/static/dashboard/media/svg/brand-logos/bebo.svg",
        info: {
      ...
      {
        image: "/static/dashboard/media/svg/brand-logos/kickstarter.svg",
        info: {
