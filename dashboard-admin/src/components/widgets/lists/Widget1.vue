...
export default defineComponent({
  ...
  setup() {
    const items = [
      ...
      {
        icon: "/static/dashboard/media/icons/duotune/art/art005.svg",
        color: "warning",
        title: "Concept Design",
        description: "Art Director",
      },
      {
        icon: "/static/dashboard/media/icons/duotune/communication/com012.svg",
        color: "primary",
        title: "Functional Logics",
        description: "Lead Developer",
      },
      {
        icon: "/static/dashboard/media/icons/duotune/coding/cod008.svg",
        color: "danger",
        title: "Development",
        description: "DevOps",
      },
      {
        icon: "/static/dashboard/media/icons/duotune/general/gen049.svg",
        color: "info",
        title: "Testing",
