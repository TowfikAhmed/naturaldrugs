  ...
  <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
    ...
    <router-link to="/">
      <img
        ...
        "
        alt="Logo"
        src="/static/dashboard/media/logos/default-dark.svg"
        class="h-25px app-sidebar-logo-default"
      />
      <img
        v-if="themeMode === 'light' && layout === 'light-sidebar'"
        alt="Logo"
        src="/static/dashboard/media/logos/default.svg"
        class="h-25px app-sidebar-logo-default"
      />
      <img
        alt="Logo"
        src="/static/dashboard/media/logos/default-small.svg"
    ...
    >
      <span class="svg-icon svg-icon-2 rotate-180">
        <inline-svg src="/static/dashboard/media/icons/duotune/arrows/arr079.svg" />
      </span>
    </div>
    <!--end::Sidebar toggle-->
  </div>
