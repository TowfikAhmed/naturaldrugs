  ...
  setup() {
    const items = [
      [
        {
          icon: {
            file: "/static/dashboard/media/icons/duotune/coding/cod002.svg",
            color: "success",
          },
          info: {
            title: "Media Device",
        ...
        {
          icon: {
            file: "/static/dashboard/media/icons/duotune/general/gen024.svg",
            color: "danger",
          },
          info: {
            title: "Special Meal",
        ...
        {
          icon: {
            file: "/static/dashboard/media/icons/duotune/maps/map004.svg",
            color: "primary",
          },
          info: {
            title: "New Users",
        ...
        {
          icon: {
            file: "/static/dashboard/media/icons/duotune/abstract/abs027.svg",
            color: "warning",
          },
          info: {
        ...
        {
          icon: {
            file: "/static/dashboard/media/icons/duotune/art/art007.svg",
            color: "info",
          },
          info: {
      ...
      [
        {
          icon: {
            file: "/static/dashboard/media/icons/duotune/abstract/abs042.svg",
            color: "info",
          },
          info: {
            title: "Strawberry Boxes",
      ...
      [
        {
          icon: {
            file: "/static/dashboard/media/icons/duotune/ecommerce/ecm002.svg",
            color: "success",
          },
          info: {
            title: "Media Device",
