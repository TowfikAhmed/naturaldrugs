                  ...
                  <td>
                    <div class="symbol symbol-45px me-2">
                      <span class="symbol-label">
                        <img
                          src="/static/dashboard/media/svg/brand-logos/plurk.svg"
                ...
                <tr>
                  <td>
                    <div class="symbol symbol-45px me-2">
                      <span class="symbol-label">
                        <img
                          src="/static/dashboard/media/svg/brand-logos/telegram.svg"
                          class="h-50 align-self-center"
                          alt=""
                        />
                      </span>
                ...
                <tr>
                  <td>
                    <div class="symbol symbol-45px me-2">
                      <span class="symbol-label">
                        <img
                          src="/static/dashboard/media/svg/brand-logos/vimeo.svg"
                          class="h-50 align-self-center"
                          alt=""
                        />
                      </span>
                ...
                <tr>
                  <td>
                    <div class="symbol symbol-45px me-2">
                      <span class="symbol-label">
                        <img
                          src="/static/dashboard/media/svg/brand-logos/bebo.svg"
                          class="h-50 align-self-center"
                          alt=""
                        />
                      </span>
                ...
                <tr>
                  <td>
                    <div class="symbol symbol-45px me-2">
                      <span class="symbol-label">
                        <img
                          src="/static/dashboard/media/svg/brand-logos/kickstarter.svg"
                          class="h-50 align-self-center"
                          alt=""
                        />
                      </span>
