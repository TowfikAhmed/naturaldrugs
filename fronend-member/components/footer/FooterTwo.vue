                ...
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        <div class="edu-footer-widget">
                            <div class="logo">
                                <n-link to="/">
                                    <img class="logo-light" src="/static/home/images/logo/logo-dark.png" alt="Dark Logo">
                                    <img class="logo-dark" src="/static/home/images/logo/logo-white.png" alt="Light Logo">
                                </n-link>
                            </div>
                            <p class="description">Natural drugs are generally considered safe when used as directed. However, as with any type of drug, there is always the potential for side effects.</p>
                            <div class="widget-information">
                                <ul class="information-list">
                                    <li><span>Add:</span>70-80 Upper St Norwich NR2</li>
                                    <li><span>Call:</span><a href="tel:+011235641231">+01 123 5641 231</a></li>
                                    <li><span>Email:</span><a href="mailto:info@naturaldrugs.com" target="_blank">info@naturaldrugs.com</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="edu-footer-widget explore-widget">
                            ...
                            <div class="inner">
                                <ul class="footer-link link-hover">
                                    ...
                                    <li><n-link to="/instructor/instructor-profile">Vendor List</n-link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
