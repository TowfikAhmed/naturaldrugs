<template>
    <div class="pv-demo-area" id="demos">
        <div class="container-custom">
            <div class="row">
                <div class="col-lg-12">
                    <SectionTitle preTitle='Unique Demos' title='8+ Pre-Made Creative Online Course <br> Education Homepage' alignment='section-center splash-title' disableMark />
                </div>
            </div>
            ...
            <div class="row row--30">
                ...
                >
                    <div class="single-demo">
                        <span class="new-wrapper" v-if="demo.new">New</span>
                        <div class="inner">
                            <div class="thumbnail">
                                <n-link :to="demo.link" target="_blank" class="thumbnail-link">
                                    <img :src="'/images/preview/' + demo.imageSrc" alt="Preview Image" />
                                </n-link>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-aos-delay="100" data-aos="fade-up" data-aos-duration="800">
                    <div class="single-demo">
                        <div class="inner">
                            <div class="thumbnail">
                                <a class="thumbnail-link" href="https://www.edublink.vue.dark.devsblink.com" target="_blank">
                                    <img src="/images/preview/dark-version.png" alt="Preview Images">
                                </a>
                                <div class="hover-action">
                                    <a class="edu-btn btn-large" href="https://www.edublink.vue.dark.devsblink.com" target="_blank">View Demo <i class="icon-4"></i></a>
                                </div>
                            </div>
                            <h5 class="title"><a href="https://www.edublink.vue.dark.devsblink.com" target="_blank">Dark Skin</a></h5>
                        </div>
                    </div>
                </div>
            ...
            return {
                homeDemos: [
                    ...
                    },
                    {
                        ...
                        imageSrc: 'home-modern-schooling.jpg',
