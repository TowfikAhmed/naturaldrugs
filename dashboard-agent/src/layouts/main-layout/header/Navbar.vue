<template>
  ...
  <div class="app-navbar flex-shrink-0">
    ...
    <div class="app-navbar-item ms-1 ms-lg-3">
      ...
      >
        <span class="svg-icon svg-icon-1">
          <inline-svg src="/static/dashboard/media/icons/duotune/general/gen022.svg" />
        </span>
      </div>
      <KTNotificationMenu />
      <!--end::Menu wrapper-->
    ...
    <div class="app-navbar-item ms-1 ms-lg-3">
      ...
      >
        <span class="svg-icon svg-icon-1">
          <inline-svg src="/static/dashboard/media/icons/duotune/general/gen025.svg" />
        </span>
      </div>
      <KTQuickLinksMenu />
      <!--end::Menu wrapper-->
    ...
    <div class="app-navbar-item ms-1 ms-lg-3">
      ...
      >
        ...
        >
          <inline-svg src="/static/dashboard/media/icons/duotune/general/gen060.svg" />
        </span>
        <span v-else class="svg-icon theme-light-hide svg-icon-2">
          <inline-svg src="/static/dashboard/media/icons/duotune/general/gen061.svg" />
        </span>
      </a>
      <!--begin::Menu toggle-->
      <KTThemeModeSwitcher />
    ...
    <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
      ...
      <div
        ...
        data-kt-menu-placement="bottom-end"
      >
        <img src="/static/dashboard/media/avatars/300-1.jpg" alt="user" />
      </div>
      <KTUserMenu />
      <!--end::Menu wrapper-->
    </div>
