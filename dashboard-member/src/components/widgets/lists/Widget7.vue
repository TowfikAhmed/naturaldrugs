...
export default defineComponent({
  ...
  setup() {
    const list = ref([
      {
        image: "/static/dashboard/media/stock/600x400/img-20.jpg",
        title: "Cup & Green",
        size: "87KB",
        color: "success",
        status: "Approved",
      ...
      {
        image: "/static/dashboard/media/stock/600x400/img-19.jpg",
      ...
      {
        image: "/static/dashboard/media/stock/600x400/img-25.jpg",
        title: "Nike & Blue",
        size: "87KB",
        color: "success",
        status: "Success",
      ...
      {
        image: "/static/dashboard/media/stock/600x400/img-24.jpg",
        title: "Red Boots",
        size: "345KB",
        color: "danger",
        status: "Rejected",
