            ...
            <div
                ...
                style="
                    background-image: linear-gradient(
                        ...
                        url(../../images/signin-left.jpg);
                "
            >
                <div class="px-10">
                    <p class="text-4xl text-white font-bold mb-3">
                        Signin your account ?
                    </p>
                    <BaseBtn
            ...
            <div class="col-span-12 h-screen lg:col-span-5">
                <div class="h-full overflow-scroll">
                    ...
                    <div class="px-10 pt-10">
                        ...
                        <BaseBtn block class="bg-primary text-white mb-3"
                            >Sign Up</BaseBtn
                        >
                        <div class="block lg:hidden">
                            <BaseBtn
                                block
                                class="bg-primary mb-2 text-white mb-3"
                                >Sign In</BaseBtn
                            >
                        </div>
                        <div class="mb-8"></div>
                        ...
                        <div class="text-center">
                            <p class="text-base font-black mb-8">
                                Sign Up WIth
                            </p>
                        </div>
                        <div
