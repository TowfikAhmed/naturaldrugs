<template>
    <div class="signin4">
        <div class="grid grid-cols-12">
            <div
                class="col-span-12 h-screen justify-center items-center hidden lg:flex lg:col-span-7"
                style="
            ...
            >
                <div class="px-10">
                    ...
                    <p class="text-base text-white font-semibold mb-5">
                ...
                <div class="h-full overflow-scroll">
                    <div class="flex justify-center">
                        <div class="my-10 text-center">
                            ...
                            <p class="text-lg text-primary font-black">
                                Gull Admin
                            </p>
                    ...
                    <div class="px-10 pt-10">
                        <div class="mb-4">
                            <input
                                class="px-4 py-1 focus:outline-none border border-gray-300 rounded w-full"
                                type="text"
                        ...
                        <label class="inline-flex items-center mt-3 mb-4">
                            <input
                                class="form-checkbox h-5 w-5 border border-gray-900 text-primary rounded"
                                type="checkbox"
                                checked=""
                        ...
                        <BaseBtn block class="bg-primary text-white"
                            >Signin</BaseBtn
                        >
                        ...
                        <div
                            class="flex justify-center flex-wrap text-center mb-8"
                        >
                            <BaseBtn
                                class="mr-2 mb-3 border border-danger text-danger hover:bg-danger hover:text-white"
                                >Google</BaseBtn
                            >
                            <BaseBtn
                                class="mr-2 mb-3 border border-info text-info hover:bg-info hover:text-white"
                                >Facebook</BaseBtn
                            >
                            <BaseBtn
                                class="mr-2 mb-3 border border-primary text-primary hover:bg-primary hover:text-white"
                                >Twitter</BaseBtn
                            >
                        </div>
                    </div>
