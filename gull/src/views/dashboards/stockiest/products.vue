                    ...
                    >
                        <BaseCard noPadding class="overflow-hidden relative">
                            ...
                            <div class="absolute flex items-center gap-0 top-1 left-1 z-50">
                                ...
                                <p class="text-bold drop-shadow-[0px_0px_2px_black] text-white bg-gray-700 rounded left-[60%] z-[-1] px-4 absolute">{{item.point}}</p>
                            </div>
                            <p class="font-semibold mb-1 px-3 py-2 bg-gray-200">{{item.title}}</p>
                            <div class="p-3">
                                <div class="mb-1">
                                    <a
                                        ...
                                        href="#"
                                        > 
                                            <span> Trade Price: ৳ <span class="font-bold">{{item.trade_price}}</span></span>
                                            <span class="text-gray-400 text-sm"> MRP: ৳ {{item.mrp}} </span>
                                    </a>
                                </div>
...
export default {
    ...
    methods: {
        ...
        checkout(){
            ...
            axios.post('/api/member/products/', this.cart).then((response)=>{
                console.log(response);
