    ...
    >
        <div class="side-content-wrap">
            ...
            >
                ...
                >
                    <li>
                        <router-link tag="a" to="/dashboards/member" >
                            <i class="nav-icon i-Bar-Chart mr-2"></i>
                            <span class="item-name"> Dashboard Overview </span>
                        </router-link>
                    </li>
                    <li>
                        <router-link tag="a" to="/dashboards/member/tree" >
                            <i class="nav-icon i-Receipt mr-2"></i>
                            <span class="item-name"> My Team Tree </span>
                        </router-link>
                    </li>
                    <li>
                        <router-link tag="a" to="/dashboards/member/overview" >
                            <i class="nav-icon i-Receipt mr-2"></i>
                            <span class="item-name">Bonus Report</span>
                        </router-link>
                    </li>
                    <li>
                        <router-link tag="a" to="/dashboards/member/overview" >
                            <i class="nav-icon i-Receipt mr-2"></i>
                            <span class="item-name"> Stokiest Refer Bonus </span>
                        </router-link>
                    </li>
                </ul>
                <ul
                    class="mb-4 childNav"
                    data-parent="rank"
                    :class="selectedParentMenu == 'rank' ? 'block' : 'hidden'"
                >
                    <li>
                        <router-link tag="a" class to="/dashboards/member/chat">
                            <i class="nav-icon i-Police text-base mr-2"></i>
                            <span class="item-name"> Incentive & Honorarium </span>
                        </router-link>
                    </li>
                </ul>
                <ul
                ...
                >
                    <li>
                        <router-link tag="a" class to="/dashboards/member/badges">
                            <i class="nav-icon i-Mail-Money mr-2"></i>
                            <span class="item-name"> Withdraw Balance </span>
                        </router-link>
                    </li>
                    <li>
                        <router-link tag="a" class to="/dashboards/member/accordions">
                            <i
                ...
                >
                    <li>
                        <router-link tag="a" to="/dashboards/member/profileOne">
...
.side-content-wrap {
    ...
    .sidebar-left-secondary {
        ...
        padding: 0.75rem 0;
        transition: left 0.24s ease-in-out;
        box-shadow: 5px 0px 20px rgb(136, 136, 136);
        // background: #fff;
