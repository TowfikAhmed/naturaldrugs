...
<template>
    <div>
        ...
        <div
            class="container mx-auto search-ui bg-white dark:bg-dark"
        ...
        >
            <div class="flex justify-between items-center">
                ...
                <button role="button" class="btn" @click="isSearchOpen = false">
                    <i class="i-Close-Window text-xl text-gray-600"></i>
                </button>
            </div>
            <input
                class="dark:bg-dark border-transparent focus:outline-none text-6xl mb-7"
                type="text"
            ...
            <div>
                ...
                <div
                    ...
                    :key="index"
                    class="flex dark:bg-foreground overflow-hidden flex-row mb-6 shadow-md rounded-xl"
                >
                    <div class="flex">
                        <img
                    ...
                    <div class="flex pl-2 flex-1">
                        ...
                        >
                            ...
                            <div v-else>
                                <span
                                    class="rounded text-white bg-primary font-bold text-xs leading-4 py-1 px-2 mr-5"
                                    >{{ item.badge }}</span
                                >
                            </div>
                        </div>
