<template>
    <section class="container mx-auto mb-20 text-gray-700 py-10">
      ...
      <div class="grid md:grid-cols-4 gap-6 text-center">
        <div>
          <div class="block rounded-lg shadow-lg bg-white">
            <div class="overflow-hidden rounded-t-lg h-8 bg-primary" style=""></div>
            <div class="w-24 -mt-12 overflow-hidden border border-8 border-white rounded-full mx-auto bg-white">
        ...
        <div>
          <div class="block rounded-lg shadow-lg bg-white">
            <div class="overflow-hidden rounded-t-lg h-8 bg-danger" style=""></div>
            <div class="w-24 -mt-12 overflow-hidden border border-8 border-white rounded-full mx-auto bg-white">
              <img src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/img%20(1).webp" />
            </div>
            <div class="p-6">
        ...
        <div>
          <div class="block rounded-lg shadow-lg bg-white">
            <div class="overflow-hidden rounded-t-lg h-8 bg-warning" style=""></div>
            <div class="w-24 -mt-12 overflow-hidden border border-8 border-white rounded-full mx-auto bg-white">
        ...
        <div>
          <div class="block rounded-lg shadow-lg bg-white">
            <div class="overflow-hidden rounded-t-lg h-8 bg-info" style=""></div>
            <div class="w-24 -mt-12 overflow-hidden border border-8 border-white rounded-full mx-auto bg-white">
