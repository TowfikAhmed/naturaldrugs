...
export default defineComponent({
  ...
  setup() {
    const items = [
      {
        icon: "/static/dashboard/media/icons/duotune/ecommerce/ecm002.svg",
        color: "success",
        title: "Top Authors",
      ...
      {
        icon: "/static/dashboard/media/icons/duotune/general/gen024.svg",
        color: "danger",
      ...
      {
        icon: "/static/dashboard/media/icons/duotune/finance/fin006.svg",
        color: "info",
        title: "New Users",
      ...
      {
        icon: "/static/dashboard/media/icons/duotune/abstract/abs027.svg",
        color: "warning",
      ...
      {
        icon: "/static/dashboard/media/icons/duotune/abstract/abs042.svg",
        color: "primary",
        title: "Active Customers",
        description: "Best Customers",
